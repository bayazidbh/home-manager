...
services.flatpak = {
    ...
    packages = [
     ...
     "flathub:app/com.quexten.Goldwarden/x86_64/stable"
     ...
     "flathub:app/org.yuzu_emu.yuzu/x86_64/stable"
     "flathub:app/org.ryujinx.Ryujinx/x86_64/stable"
     "flathub:app/org.citra_emu.citra/x86_64/stable"
     "flathub:app/net.rpcs3.RPCS3/x86_64/stable"
     "flathub:app/net.pcsx2.PCSX2/x86_64/stable"
