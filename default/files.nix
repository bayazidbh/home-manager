...
home.file."setup-distrobox-arch" = {
  ...
  distrobox enter arch -- paru -Syyu --noconfirm --skipreview base-devel git nano alsa-lib lib32-alsa-lib alsa-plugins lib32-alsa-plugins libpulse lib32-libpulse alsa-tools alsa-utils pipewire lib32-pipewire wireplumber pipewire-jack lib32-pipewire-jack mesa lib32-sdl12-compat lib32-mesa vulkan-radeon lib32-vulkan-radeon vulkan-icd-loader lib32-vulkan-icd-loader vulkan-mesa-layers lib32-vulkan-mesa-layers libva-mesa-driver lib32-libva-mesa-driver mesa-utils vulkan-tools libva-utils lib32-mesa-utils wine-tkg-staging-fsync-git winetricks-git wine-nine wineasio giflib lib32-giflib libpng lib32-libpng libldap lib32-libldap gnutls lib32-gnutls mpg123 lib32-mpg123 openal lib32-openal v4l-utils lib32-v4l-utils libpulse lib32-libpulse alsa-plugins lib32-alsa-plugins alsa-lib lib32-alsa-lib libjpeg-turbo lib32-libjpeg-turbo libxcomposite lib32-libxcomposite libxinerama lib32-libxinerama libxslt lib32-libxslt libva lib32-libva gtk3-classic lib32-gtk3 vulkan-icd-loader lib32-vulkan-icd-loader sdl2 lib32-sdl2 vkd3d lib32-vkd3d libgphoto2 ffmpeg gst-plugins-good gst-plugins-bad gst-plugins-ugly gst-plugins-base lib32-gst-plugins-good lib32-gst-plugins-base gst-libav wget faudio lib32-faudio zsh fish lxterminal htop minizip eza bat aria2 wget sqlitebrowser xorg-server-xephyr xorg-xwayland wayland lib32-wayland qt5-wayland qt6-wayland libdbusmenu-qt5 libdbusmenu-qt6 libdbusmenu-gtk3 libdbusmenu-gtk2 appmenu-gtk-module ttf-meslo-nerd-font-powerlevel10k ttf-ibm-plex ttf-ms-fonts plasma5-theme-monterey-git plasma5-themes-whitesur-git whitesur-icon-theme-git whitesur-cursor-theme-git whitesur-gtk-theme-git adwaita-icon-theme steam steam-native-runtime protontricks-git xdg-desktop-portal-kde plasma-browser-integration peazip-qt5 p7zip unrar unarchiver lzop lrzip arj spotify-adblock-git qtscrcpy scrcpy masterpdfeditor-free exifcleaner-bin teams-for-linux onedrive-abraunegg onedrivegui onedriver gamemode lib32-gamemode mangohud-git bottles itch-setup-bin lutris anime-games-launcher-bin pcsx2-git ppsspp rpcs3-git duckstation-git vita3k-avx-git melonds-git ryujinx-git yuzu-early-access citra-canary-git gimp-git curtail anydesk-bin vlc-wayland-git firejail firetools discord discord-rpc-git tesseract-data-eng tesseract-data-ind tesseract-data-jpn tesseract-data-jpn_vert libreoffice-fresh pstoedit coin-or-mp libpaper gst-plugins-base-libs sane unixodbc kio qt6-base btrfs-progs udisks2-btrfs gamescope-plus wine-ge-custom-opt  thorium-browser-bin junction sgdboop-bin thcrap-steam-proton-wrapper-git obs-studio-amf mpv-discordrpc mpv-discord-git 4kvideodownloaderplus archisteamfarm-bin wl-clipboard wl-clipboard-x11 gamescope-plus
